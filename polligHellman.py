# This is the Pohlig-hellman algorithm. Output is similar to computation by hand. Showing a step by step process to go through. Hopefully, this will be sufficient for people going into cryptography.
